...
<div class="relative bg-teal-950">
    ...
    <header class="bg-slate-900 w-full h-24 flex items-center px-8 justify-between">
        ...
        <div class="hidden md:block bg-amber-200 rounded-full px-6 py-2 text-black font-bold font-['Inter']">
            Login
        </div>
    ...
    <nav id="mobile-menu" class="bg-slate-900 w-full hidden flex-col items-center text-neutral-100 text-base font-bold font-['Inter'] mt-24">
        ...
        <div class="bg-amber-200 rounded-full px-6 py-2 text-black font-bold mt-4">
            Login
        </div>
    </nav>
    <!-- Main Content -->
        ...
        <section id="home" class="relative w-full bg-white flex flex-col md:flex-row items-center justify-center py-16">
            ...
            <div class="md:w-1/2 p-8 flex flex-col items-center">
                ...
                <div class="flex space-x-4">
                    <a href="#" class="bg-green-500 text-white px-6 py-3 rounded-full font-bold font-['Inter']"><img
                            src="{{asset('app-store.png')}}" alt=""></a>
                    <a href="#" class="bg-blue-500 text-white px-6 py-3 rounded-full font-bold font-['Inter']"><img
                            src="{{asset('google-app-store.png')}}" alt=""></a>
                </div>
            </div>
        </section>
        <!-- About Section -->
