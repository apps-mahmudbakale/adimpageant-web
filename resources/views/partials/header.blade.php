<div
    class="sticky top-0 z-40 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-gray-900 px-4 shadow-sm sm:gap-x-6 sm:px-6 lg:px-8">
    <button onclick="toggleElement('#mobile-menu')" type="button" class="-m-2.5 p-2.5 text-gray-700 lg:hidden">
    ...
    <div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
        ...
        <div class="flex items-center gap-x-4 lg:gap-x-6">
            ...
            <div id="dropdownMenu" class="relative">
                <button onclick="toggleElement('#dropdownMenu #dropdown')" type="button" class="-m-1.5 flex items-center p-1.5"
                        id="user-menu-button"
