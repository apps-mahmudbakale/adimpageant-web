...
<main class="py-10">
    <div class="px-4 sm:px-6 lg:px-8">
        <h2 class="text-center font-['Inter'] text-2xl uppercase font-semibold py-2">Create Contestant</h2>
    ...
    function resizeImage() {
        ...
        reader.onload = function(event) {
            ...
            image.onload = function() {
                const originalSize = `${image.width}x${image.height}`; // Calculate original size
                ...
                document.getElementById('profile-image').src = canvas.toDataURL('image/jpeg',
                    0.7); // Adjust quality (0-1)

                // Log original and new sizes
                console.log(`Original size: ${originalSize}`);
                console.log(`Resized size: ${newWidth}x${newHeight}`);
            };
